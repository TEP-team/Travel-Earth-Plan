...
ModularUtils.itemRecipeBuilder(machine ~ "_6_" ~ 5, machine, 100, 36,
    [<ore:plateIron>.firstItem*4, <ore:stickIron>.firstItem],
...
ModularUtils.itemRecipeBuilder(machine ~ "_6_" ~ 7, machine, 200, 20,
    [<immersiveengineering:material:22>*4, <ore:dustIron>.firstItem*4, <contenttweaker:material_part:32>],
    [<contenttweaker:motor>], true, true).build();

ModularUtils.itemRecipeBuilder(machine ~ "_6_" ~ 8, machine, 400, 25,
    [<ore:stickIron>.firstItem*4, <ore:dustCopper>.firstItem*2, <ore:dustNickel>.firstItem*2, <mekanism:reinforcedalloy>],
    [<mekanismgenerators:generator:7>], true, true).build();

ModularUtils.itemRecipeBuilder(machine ~ "_6_" ~ 9, machine, 400, 25,
    [<contenttweaker:material_part:79>*4, <contenttweaker:material_part:81>*4, <ore:stickIron>.firstItem],
...
ModularUtils.itemRecipeBuilder(machine ~ "_6_" ~ 13, machine, 600, 30,
    [<mekanism:reinforcedalloy>*3, <immersiveengineering:material:1>, <immersiveengineering:material:3>, <mekanism:dust:5>*4, <mekanism:dust:1>*4, <mekanism:dust:2>*4, <mekanism:enrichediron>*4, <mekanism:polyethene:2>*2, <ore:plateIron>.firstItem*2],
