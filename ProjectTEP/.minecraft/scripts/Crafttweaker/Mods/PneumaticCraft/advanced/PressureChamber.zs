...
pressurechamber.addRecipe([<minecraft:paper>*9], 1.0, [<contenttweaker:papers>]);
...
pressurechamber.addRecipe([<pneumaticcraft:plastic:2>, <pneumaticcraft:plastic:11>, <contenttweaker:material_part:38>], 1.5, [<pneumaticcraft:empty_pcb:100>]);
